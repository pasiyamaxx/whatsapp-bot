  ...
  for (const command of plugins.commands) {
   ...
   if (msg.body && command.pattern) {
    ...
    const commandHandlers = {
     ...
     image: () => msg.type === 'imageMessage' && executeCommand(Message, [msg.body]),
     sticker: () => msg.type === 'stickerMessage' && executeCommand(Message, []),
     video: () => msg.type === 'videoMessage' && executeCommand(Message, []),
     delete: () => {
